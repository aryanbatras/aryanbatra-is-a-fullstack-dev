...
/**
 * React Bits <ShapeBlur /> — a morphing glass shape rendered by a WebGL
 * fragment shader. The SDF reacts to the mouse with an eased hover circle.
 * Used on the lock screen as a liquid-glass backdrop behind the avatar.
 */
const ShapeBlur = ({
  className = "",
  variation = 0,
