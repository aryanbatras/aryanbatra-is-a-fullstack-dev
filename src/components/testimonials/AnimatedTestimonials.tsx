...
export const AnimatedTestimonials = ({
  ...
  // Deterministic per-index rotation — Math.random() here would render
  // different values on the server and client, breaking hydration.
  const rotateFor = (index: number) => ((index % 7) - 3) * 3;
